...
#define CUSTOM_MACHINE_NAME "Ender3V2-422-IND"
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // Probe connected to BL_T port
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -1, 0 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   3 // (mm) Z Clearance for Deploy/Stow  // MRiscoC EZABL from TH3DStudio
#define Z_CLEARANCE_BETWEEN_PROBES  2 // (mm) Z Clearance between probe points  // MRiscoC EZABL from TH3DStudio
#define Z_CLEARANCE_MULTI_PROBE     2 // (mm) Z Clearance between multiple probes  // EZABL from TH3DStudio
#define Z_PROBE_ERROR_TOLERANCE     3 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping  // MRiscoC EZABL from TH3DStudio
